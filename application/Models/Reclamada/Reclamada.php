...
class Reclamada extends Model
{
    ...
    /**
     * Busca reclamadas para DataTables (Server-Side Processing)
     */
    public function getReclamadasDataTable(int $empresa, array $params, array $filtros = []): array
    {
        ...
        $baseQuery = "SELECT * FROM reclamadas";
