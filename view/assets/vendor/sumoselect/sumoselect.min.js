      ...
      const ret = this.each(function () {
        ...
        this.sumo = {
          ...
          createElems() {
            ...
            O.select = O.E.parent();
            O.caption = $('<span>');
            O.CaptionCont = $(`<p class="CaptionCont SelectBox ${O.E.attr('class')}" style="" ><label><i></i></label></p>`)
          ...
          createLi(opt, d) {
            ...
            let cor = opt.attr('data-color');
            let cor_base = opt.attr('data-color');
            if(cor != undefined){
                cor = '<strong style="background-color: '+cor+'"></strong>';
            }else{
                cor = '';
            }
            const li = $(`<li class="opt" data-color="${cor_base}"><label>${cor}${opt.html()}</label></li>`);
          ...
          setText() {
            ...
            if (O.is_multi) {
              ...
              O.color = option.attr('data-color');
            ...
            if (settings.showTitle){
                ...
                O.CaptionCont.attr('style', 'background-color:'+O.color);
            }
