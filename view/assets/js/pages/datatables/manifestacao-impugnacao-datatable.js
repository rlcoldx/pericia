...
(function() {
    ...
    function init() {
        ...
        const columns = [
            ...
            { data: 2, name: 'numero', orderable: true, searchable: true },
            { data: 3, name: 'reclamada', orderable: true, searchable: true },
            { data: 4, name: 'reclamante', orderable: true, searchable: true },
            { data: 5, name: 'favoravel', orderable: true, searchable: false },
            { data: 6, name: 'perito', orderable: true, searchable: true },
